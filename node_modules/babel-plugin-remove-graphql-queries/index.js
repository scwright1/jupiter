      ...
      Program(path, state) {
        ...
        path.traverse({
          TaggedTemplateExpression(path2, state) {
            var _path2$parentPath, _path2$parentPath$par, _path2$parentPath$par2, _path2$parentPath$par3, _path2$parentPath$par4;

            const _getGraphQLTag = getGraphQLTag(path2),
            ...
            path2.replaceWith(t.StringLiteral(queryHash)); // modify StaticQuery elements and import data only if query is inside StaticQuery

            if (((_path2$parentPath = path2.parentPath) === null || _path2$parentPath === void 0 ? void 0 : (_path2$parentPath$par = _path2$parentPath.parentPath) === null || _path2$parentPath$par === void 0 ? void 0 : (_path2$parentPath$par2 = _path2$parentPath$par.parentPath) === null || _path2$parentPath$par2 === void 0 ? void 0 : (_path2$parentPath$par3 = _path2$parentPath$par2.node) === null || _path2$parentPath$par3 === void 0 ? void 0 : (_path2$parentPath$par4 = _path2$parentPath$par3.name) === null || _path2$parentPath$par4 === void 0 ? void 0 : _path2$parentPath$par4.name) === `StaticQuery`) {
